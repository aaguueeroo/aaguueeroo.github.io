...
`}e+=`
`;const r={quality:"Quality",speed:"Speed",budget:"Budget"},i=t["project-details"];if(i&&i.length>0){const o=i.map(a=>r[a]??a).join(", ");e+=`Project Priorities: ${o}
`}if(e+=`
...
`)}return e};export{f as formatFormData,d as generateEmailBody,m as submitQuoteForm,l as validateContactInfo};
